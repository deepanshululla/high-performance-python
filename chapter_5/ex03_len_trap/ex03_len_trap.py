...
Run (time):   .venv/bin/python chapter_5/ex03_len_trap/ex03_len_trap.py
Run (memory): .venv/bin/python -m memory_profiler chapter_5/ex03_len_trap/ex03_len_trap.py
"""
import builtins
import pathlib
import sys
...
def main():
    ...
    print("\n(RSS view: .venv/bin/python -m memory_profiler chapter_5/ex03_len_trap/ex03_len_trap.py)")
