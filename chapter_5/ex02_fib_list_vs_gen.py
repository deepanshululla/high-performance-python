...
Run (time):   .venv/bin/python chapter_5/ex02_fib_list_vs_gen.py
Run (memory): .venv/bin/python -m memory_profiler chapter_5/ex02_fib_list_vs_gen.py
...
def main():
    ...
    print("\n(For RSS-based numbers: .venv/bin/python -m memory_profiler chapter_5/ex02_fib_list_vs_gen.py)")
