"""Build _cyjulia_sched with numpy headers and OpenMP, mirroring the book's Example 8-11.
...
setup(name="_cyjulia_sched", ext_modules=cythonize([ext], language_level=3))
...
def _fix_macos_libomp_path():
    ...
    for so in glob.glob("_cyjulia_sched*.so"):
